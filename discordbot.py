...
async def dice(ctx,diceinp):
    ...
    diceres = sum(ans) 
    anss = "/spoiler message" + str(ans)
    diceress = "/spoiler message:" + str(diceres)
...
async def kiroku(ctx):
    meigen = ["ぱぱ「再接続したら……お前しかいなかった……」","ポンズ。スマホトイレ監禁の巻","ろいぽっぷ「ビジネスバパだったの……？」","すてら「はずさんの声、なんかすごい脳です」","ずっかい「冷凍イカになっちゃう！！！」","まは「びーふおあちきんみたいな人が通ってる（新幹線の車内販売員のこと）」","しぐれ「水彩画で林檎をもちにき！」","はず「ペンギンは鳥じゃない！」","いろは「ぴーちゃんのおりえさんかわいい」","もちにき「サンリオも人に手ぇ出して久しいからな……」","ゆっか「じゃあ口裂けろ」","ろいぽっぷ「回線の一撃」","ろいぽっぷ「いや～そこ二狼かぁ～…（三人盤面）」",'すてら「狐につつまれる」',"はず「茨城はいばらきだけど(ﾄﾞﾔｧ)」",'ぱぱ「静かなる世界に唐突なウミウシ！」',"織江「やっぱ優しい中トロは最高でした！」","まは「心に傷を負った妖精がここに飛んでいます」"]
